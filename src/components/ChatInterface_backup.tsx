...
const ChatInterface = ({ 
  ...
  useEffect(() => {
    ...
    if (branchTextareaRef.current) {
      branchTextareaRef.current.style.height = 'auto';
      branchTextareaRef.current.style.height = `${branchTextareaRef.current.scrollHeight}px`;
    }
  }, [inputValue]);
